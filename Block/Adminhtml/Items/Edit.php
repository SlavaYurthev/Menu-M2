 ...
 */
namespace SY\Menu\Block\Adminhtml\Items;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container {
	...
	protected function _construct(){
		...
		$this->_blockGroup = 'SY_Menu';
		$this->_controller = 'adminhtml_items';
		parent::_construct();
		if ($this->_isAllowedAction('SY_Menu::items')) {
	...
	public function getHeaderText(){
		if ($this->_coreRegistry->registry('sy_menu_item')->getId()) {
			return __("Edit Item '%1'", $this->escapeHtml($this->_coreRegistry->registry('sy_menu_item')->getId()));
		} else {
			return __('New Item');
		}
	}
